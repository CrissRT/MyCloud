...
export const useMeServiceGetAccountMe = <
...
export const usePreferencesServicePatchAccountPreferences = <
  TData = Common.PreferencesServicePatchAccountPreferencesMutationResult,
  TError = unknown,
  TContext = unknown
>(
  options?: Omit<
  ...
  >({
    mutationFn: ({ requestBody }) =>
      PreferencesService.patchAccountPreferences({ requestBody }) as unknown as Promise<TData>,
    ...options
  });
