...
export type MeServiceGetAccountMeQueryResult<
  TData = MeServiceGetAccountMeDefaultResponse,
  TError = unknown
> = UseQueryResult<TData, TError>;
export const useMeServiceGetAccountMeKey = 'MeServiceGetAccountMe';
export const UseMeServiceGetAccountMeKeyFn = (queryKey?: Array<unknown>) => [
  useMeServiceGetAccountMeKey,
  ...(queryKey ?? [])
];
...
export type ForgotPasswordServicePostAuthForgotPasswordMutationResult = Awaited<
  ReturnType<typeof ForgotPasswordService.postAuthForgotPassword>
>;
...
export type PreferencesServicePatchAccountPreferencesMutationResult = Awaited<
  ReturnType<typeof PreferencesService.patchAccountPreferences>
>;
